...
echo __( "Your order is waiting for payment. The order details are shown below for your reference:", 'woopay-core' ) . "\n\n";
...
do_action( 'add_woopay_kcp_virtual_bank_information', $order, $sent_to_admin, $plain_text );
